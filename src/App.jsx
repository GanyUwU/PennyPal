...
function App() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <div className="text-right">
              ...
              <p className="text-white font-black text-2xl transition-all duration-500 hover:scale-110">
                ₹42,150
              </p>
            </div>
            <div
            ...
            >
              ...
              <div>
                ...
                >
                  {session?.user?.user_metadata?.occupation}
                </p>
              </div>
            </div>
            <Button
      ...
      {/* Navigation */}
      <nav
        className={`border-b-4 p-4 m-2 border-black ${
  ...
  return (
    <div className="space-y-8">
        ...
        {aiAgents.map((agent, index) => (
          ...
          >
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`p-2 border-2 border-black rounded-2xl ${
                    darkMode ? "bg-gray-700 text-white" : "bg-black text-white"
                  }`}
                >
                  {agent.icon}
                </div>
                <div className="flex items-center gap-2">
                  ...
                  ></span>
                  <span
                    className={`text-xs font-bold status-indicator ${
                      darkMode ? "text-gray-400" : "text-gray-600"
                    }`}
                  >
                    {agent.status}
            ...
            <div className="space-y-2">
              ...
              {agent.saved !== "₹0" && (
                <div className="bg-blue-600 text-white p-2 border-2 border-black rounded-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Recent Activity */}
        <div
          className={`lg:col-span-1 border-8 border-black p-6 ${
            darkMode ? "bg-gray-800 text-white" : "bg-white"
          }`}
        >
        ...
        {/* Monthly Budget */}
        <div
          className={`lg:col-span-2 border-8 border-black p-6 ${
            darkMode ? "bg-gray-800 text-white" : "bg-white"
          }`}
        >
          <h3 className="font-black text-xl mb-4 border-b-4 border-black pb-2">
              ...
              <div key={index} className="flex items-center gap-4">
                ...
                <div className="flex-1 flex border-4 border-black h-8">
                  ...
                  <div
                    className="bg-gray-200"
                    style={{
                      width: `${100 - (data.amount / 35000) * 100}%`,
                    }}
                  ></div>
                </div>
                <span className="font-black text-sm w-20">
...
function PaymentsContent({ darkMode }) {
  ...
  return (
    <div className="space-y-6">
      <h2
        className={`text-3xl font-black border-b-4 border-black pb-2 ${
          darkMode ? "text-white" : ""
        }`}
      >
        PAYMENT MANAGEMENT
            ...
            {[
              ...
              >
                ...
                <div className="flex gap-2">
                  <Button
                    size="sm"
                    className="bg-red-500 border-2 border-black font-black hover:bg-red-600"
                  >
                    DISABLE
                  </Button>
                  <Button
                    size="sm"
                    variant="outline"
                    className="border-2 border-black font-black bg-transparent"
                  >
